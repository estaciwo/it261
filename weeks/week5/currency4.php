...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    echo '
        <div class="box">
        <h2>Hello '.$name.',</h2>
        <p>You now have <b>$'.number_format($dollars,2).' American dollars</b> and we will be emailing you at <b>'.$email.'</b> with your information, as well as depositing your funds at <b>'.$bank.' bank!</b>
        </p>
        </div>
    ';
    ...
    if($dollars >= $amount) {
        echo '<div class="happy"><h3>I am happy because I have <b>'.number_format($dollars,2).' US dollars!</b></h3><iframe width="560" height="315" src="https://www.youtube.com/embed/3eHU9Mmu_kA?si=Akf2IBZEFhH4Dl3k" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';
    } else {
        echo '<div class="sad">
        <h3>I am sad because I now only have <b>'.number_format($dollars,2).' US dollars :(</b></h3><iframe width="560" height="315" src="https://www.youtube.com/embed/HG-8uZg2uV0?si=5VuR5tFKdJ80ur1m" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>';
    }
    }
