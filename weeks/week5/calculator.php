...
if(isset($_POST['name'],
    ...
    if(isset($_POST['price']) && $_POST['price'] == '3.00') {
        ...
        if(!empty($name && $miles && $speed && $hours) && ($fuel != NULL)) {
            ...
            echo '
                <div class="box">
                <p>Hello '.$name.', you will be travelling a total of '.number_format($hourTotal,2).' hours, taking '.number_format($days,2).' days.</b> And, you will be using '.number_format($gallons,1).' gallons of gas, costing you '.number_format($dollars,2).' dollars.</p>
                </div>
                </div>
            ';
        }
